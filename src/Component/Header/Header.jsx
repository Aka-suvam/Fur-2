...
import { useState } from "react";
 ...
 const Header=()=>{
  ...
  const  mobileMenu = (location.pathname === ('/shop')|| (location.pathname.startsWith("/products/")) || location.pathname === ('/about')|| location.pathname === ('/contact') ||location.pathname === ('/Shopping-cart')) && (window.innerWidth <= 480) ? 'Mobile-menu' : 'mobile-menu' ;
